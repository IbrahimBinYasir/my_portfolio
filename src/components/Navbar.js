        ...
        <header className = "bg-gray-900 md:sticky top-0 z-10"> {/*Use sticky to position an element as relative until it crosses a specified threshold, then treat it as fixed until its parent is off screen. */}
            <div className = "container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
                <a className="title-font font-medium text-white mb-4 md:mb-0">
                    <a href = "#about" className ="ml-3 text-xl"> {/*move to a specific id with hashtags */}
                        Ibbi
                    </a>
                </a>
                <nav className="md:mr-auto md:ml-4 md:py-1 md:pl-4 md:border-l md:border-gray-700	flex flex-wrap items-center text-base justify-center">
                    ...
                    <a href = 'https://drive.google.com/file/d/1cd3Fn7G9h3pgQ5KpoXbUq9xZp1QEHwg0/view?usp=sharing'  download className = "mr-5 hover:text-green-400">
                        CV
                    </a>
                </nav>
            </div>
